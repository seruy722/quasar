      ...
      <Card style="min-width: 320px;width: 100%;max-width: 500px;">
        <CardSection class="row justify-between bg-grey q-mb-sm">
          ...
          <div>
            <IconBtn
              ...
              icon="clear"
              tooltip="Закрыть"
              @iconBtnClick="close(permissionData)"
            />
          </div>
        </CardSection>
        ...
        <CardActions>
          <BaseBtn
            ...
            color="negative"
            :dense="$q.screen.xs || $q.screen.sm"
            @clickBaseBtn="close(permissionData)"
          />
          ...
          <BaseBtn
            ...
            color="positive"
            :dense="$q.screen.xs || $q.screen.sm"
            @clickBaseBtn="checkErrors(permissionData, saveData)"
          />
        </CardActions>
      </Card>
    </Dialog>
...
<script>
    ...
    export default {
        ...
        methods: {
            saveData({ name: { value }, users: { value: usersNames }, roles: { value: rolesNames } }) {
