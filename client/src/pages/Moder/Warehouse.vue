<template>
    <div class="q-pa-md" data-vue-component-name="Warehouse">
        <q-table
            title="Treats"
            :data="data"
            :columns="columns"
        ...
        >
            <template v-slot:top="props">
                <div class="col-2 q-table__title">{{ $t('warehouse') }}</div>
                ...
                <q-space />
                <IconBtn
                    :iconBtnData="{icon: props.inFullscreen ? 'fullscreen_exit' : 'fullscreen', tooltip: props.expand ? $t('hide') : $t('reveal')}"
...
<script>
    export default {
        ...
        created() {
            ...
            devlog.log('ff', this.$q.lang.table);
        },
        methods: {
            getSelectedString() {
