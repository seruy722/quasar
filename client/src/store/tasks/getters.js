...
export const getTaskComments = ((state) => _.map(_.orderBy(state.taskComments, (item) => new Date(item.created_at), 'desc'), (item) => _.assign({}, item, { formatDate: fullDate(item.created_at) })));
